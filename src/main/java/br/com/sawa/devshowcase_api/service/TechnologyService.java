...
public class TechnologyService {
    ...
    public TechnologyService(ProfileRepository repository) { this.repository = repository; }
    @Transactional
    public ProfileResponseDTO insert(ProfileRequestDTO dto) {
        Profile profile = new Profile(); profile.setName(dto.name()); profile.setBio(dto.bio());
